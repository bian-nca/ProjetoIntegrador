...
public class Vendedores extends javax.swing.JFrame {
    ...
    public Vendedores() {
        try {
            ...
            String sql = "SELECT MAX(idvendedor) AS MAX_IDVEND FROM VENDEDORES"; //estou obtendo o ultimo valor da coluna "idvenda" da minha tablea "vendas" e irei incrementá-lo posteriormente em +1
            Connection con = SQLConection.getConnection();
            PreparedStatement stmt = con.prepareStatement(sql);
            ResultSet rs = stmt.executeQuery(sql);
            if (rs.next()) {
                int maxId = rs.getInt("MAX_IDVEND");
                int proxId = maxId + 1;
	...
	nome varchar(100) not null
         ...
         try {
                String idvend = codigo.getText();
                String vend = vendedor.getText();
                String sql = "INSERT INTO VENDEDORES(idvendedor, nome) VALUES ('"+idvend+"', '"+vend+"')";
                SQLConection conection = new SQLConection();
