 ...
 * @author Bianca
 */
public class ConsulteSaidaEstoque extends javax.swing.JFrame {

    /**
     * Creates new form ConsulteSaidaEstoque
     */
    public ConsulteSaidaEstoque() {
        initComponents();
        try{
            Connection con = SQLConection.getConnection();
            String sql = "Select * from saida_est";
            ...
            while(rs.next()){   /*Enquanto houver dados ele irá fazer esse comando para pegar todas as minhas informações*/
                modelo.addRow(new Object[]{rs.getString("id"), rs.getString("datasaida"), rs.getString("id_fornecedor"), rs.getString("fornecedor"), rs.getString("id_vend"), rs.getString("name_vend"), rs.getString("cancelada")});
            }
            con.close();
    ...
    private void initComponents() {
        ...
        setTitle("Consultar Requisições - Saída de Estoque");
        setResizable(false);
        ...
        jScrollPane1.setViewportView(tabela_saida);

        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-4, 60, 720, 273));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            Connection con = SQLConection.getConnection();
            String sql = "Select * from SAIDA_EST where fornecedor LIKE '"+pesq+"'";
            PreparedStatement stmt = con.prepareStatement(sql);
            ResultSet rs = stmt.executeQuery();
            DefaultTableModel modelo = (DefaultTableModel) tabela_saida.getModel();
            modelo.setNumRows(0); /* Vai ter nenhuma linha inicialmente, elas serão adicionadas conforme o bd for encontrando no meu banco de dados*/
            ...
            while(rs.next()){   /*Enquanto houver dados ele irá fazer esse comando para pegar todas as minhas informações*/
                modelo.addRow(new Object[]{rs.getString("id"), rs.getString("datasaida"), rs.getString("id_fornecedor"), rs.getString("fornecedor"), rs.getString("id_vend"), rs.getString("name_vend"), rs.getString("cancelada"), rs.getString("cancelada")});
            }
            con.close();
        } catch (SQLException ex) {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            while(rs.next()){   /*Enquanto houver dados ele irá fazer esse comando para pegar todas as minhas informações*/
                modelo.addRow(new Object[]{rs.getString("id"), rs.getString("datasaida"), rs.getString("id_fornecedor"), rs.getString("fornecedor"), rs.getString("id_vend"), rs.getString("name_vend")});
            }
            con.close();
        } catch (SQLException ex) {
            Logger.getLogger(ConsulteClientes.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ConsulteSaidaEstoque.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
